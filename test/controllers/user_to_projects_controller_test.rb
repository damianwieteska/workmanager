...
class UserToProjectsControllerTest < ActionController::TestCase
  ...
  test "should create user_to_project" do
    assert_difference('UserToProject.count') do
      post :create, user_to_project: { project_id: @user_to_project.project_id, role: @user_to_project.role, user_id: @user_to_project.user_id }
    end
  ...
  test "should update user_to_project" do
    patch :update, id: @user_to_project, user_to_project: { project_id: @user_to_project.project_id, role: @user_to_project.role, user_id: @user_to_project.user_id }
    assert_redirected_to user_to_project_path(assigns(:user_to_project))
  end
